...
while i <= 6:
  ...
  img = cv.imread("../images/img" + str(i) + ".png", cv.IMREAD_COLOR)
  img_gray = cv.cvtColor(img, cv.COLOR_BGR2GRAY)

  img_next = cv.imread("../images/img" + str(i+1) + ".png", cv.IMREAD_COLOR)
  ...
  cv.imwrite('../images/img' + str(i+1) + '_flow.png',img_next_flow)
